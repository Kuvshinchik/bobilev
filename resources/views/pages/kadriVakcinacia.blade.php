             ...
             <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href={{ route('worker.dashboard') }} class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href={{ route('worker.table') }} class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href={{ route('worker.analytics') }} class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
