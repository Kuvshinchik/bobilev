                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href="#" class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                                ...
                                <span>Основные кадровые показатели ДЖВ</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href="#" class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                                ...
                                <span>Укомплектование работников Дирекции в разрезе РДЖВ</span>
                            </div>
                        </a>
                    </div>
					...
					<div class="col-md-6 col-lg-4 mb-4">
                        <a href="#" class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                                <i class="mdi mdi-email-outline mdi-36px d-block mb-2"></i>
                                <span>Динамика изменения укомплектованности по основным профессиям Дирекции в разрезе РДЖВ</span>
                            </div>
                        </a>
                    </div>
					...
					<div class="col-md-6 col-lg-4 mb-4">
                        <a href="#" class="btn btn-primary btn-lg btn-block py-4 d-flex align-items-center justify-content-center text-center" style="min-height: 150px; white-space: normal;">
                            <div>
                                <i class="mdi mdi-email-outline mdi-36px d-block mb-2"></i>
                                <span>Список работников Дирекции, орган управления</span>
                            </div>
                        </a>
                    </div>
                </div>
